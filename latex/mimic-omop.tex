...
% ICU: a paradox TODO: synthetise 
Intensive Care Units (ICU) has all of the expectation, because all kind of data.
- Reusing medical data has historically been impossible for a large population
  and most of data were simply wasted due data variability and quality
  challenges
...
- The practice's variability is due to lack of adherence to best practices, but
  ...
  variation between unique patient and clinical studies
- But the ICU demand of care is rising(3) and the mortality is up to 30pourcent
