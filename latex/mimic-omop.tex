...
worldwide. In this paper, an open-source implementation of transforming MIMIC
into OMOP is presented. We evaluate the quality of the transformation, the
benefits for analysts and the gains and potentials for community contributions.
Finally the resulting MIMIC-OMOP dataset is ready for reproducible research
and is the first open-access OMOP dataset with real de-identified patient data
available.
}
