...
% Title portion
\title{MIMIC in the OMOP Common Data Model\thanks{To whom correspondence should be addressed Tel: +33111111111; e-mail: nicolas.paris@aphp.fr}}

%Author Info.
\authorgroup{
\author{Nicolas PARIS},
\role{WIND-DSI, AP-HP, Paris, France}
AND \author{Adrien PARROT},
\role{WIND-DSI, AP-HP, Paris, France}
\email{(nicolas.paris@aphp.fr)\quad\quad\quad\quad\quad\quad\quad\quad\quad\quad\quad\quad (adrien.parrot@caramail.fr)}
...
a 48-hour datathon with 160 participants.\\
