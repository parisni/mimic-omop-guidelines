...
leads to better outcomes. Last but not least, studies have show that CDM can
lead to different results \cite{cdm-comparison}.
...
and makes feedbacks to intensivists in a realtime context.

% Evaluation of MIMIC-OMOP
In order to evaluate the MIMIC-OMOP transformation, we based our work on \cite{kahn}
