...
%Abstract
\abstract{%
\textit{Objectives} : In the age of big data, the intensive care unit (ICU) is 
...
\textit{Material \& Method}: A documented, tested, versioned, exemplified and 
...
\textit{Result}: Most of the data correspond to the model and much of the 
...
\textit{Conclusion}: The resulting MIMIC-OMOP data set is ready for replicable 
