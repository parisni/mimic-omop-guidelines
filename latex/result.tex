...
% Loss of data
%
We estimated the percentage of records loaded from the source database to
MIMIC-OMOP. We estimate the percentage of both columns and rows lost in the
process as other studies have done \cite{omop-nashville}.
% loss of columns
