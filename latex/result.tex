...
are grouped by nature (such measurements) in OMMOP while MIMIC provides a table for each
Since OMOP is a conceptual model, the same type of data goes into the same table. 
The dispatching of informations reflects the different nature of both structure.
