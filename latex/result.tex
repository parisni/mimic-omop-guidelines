...
\textit{simplicity} and the performances of the model. 
...
\cite{mimic-omop-website}. All the test passed.  
...
unlimited lenght since it could cause unpredictable truncation of content, and
